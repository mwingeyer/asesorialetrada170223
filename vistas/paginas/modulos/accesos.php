        ...
        <div class="container" >
            <div class="row d-flex justify-content-between justify-content-md-around align-items-baseline">    
                <div class="col">
                    ...
                    <h2 class="h4">
                         <a class="stretched-link" target="_blank" href="<?php echo $pagina['rutaBuscadorCir'];?>">Circulares</a>               
                    </h2>
                </div>
                ...
                <div class="col">
                    ...
                    <h2 class="h4">
                        <a class="stretched-link" href="<?php echo $pagina['rutaBuscadorDic'];?>" target="_blank">Dictamenes</a>
