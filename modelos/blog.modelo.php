...
class ModeloBlog{
    ...
    /**===========================================
     Mostrar articulos y categorias con InnerJoin
    ==============================================*/
   ...
   /*=============================================
    ...
    static public function mdlTotalBuscador($tabla, $busqueda){
        ...
        $stmt = Conexion::conectar()->prepare("SELECT *FROM $tabla WHERE ruta_articulo like '%$busqueda%' OR titulo_articulo like '%$busqueda%' OR descripcion_articulo like '%$busqueda%' OR contenido_articulo like '%$busqueda%' OR p_claves_articulo like '%$busqueda%' OR ruta_articulo like '%$busqueda%'");
